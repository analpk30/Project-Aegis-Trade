...
BUCKET_NAME = os.environ.get("BUCKET_NAME", "hack-team-entscheidungsproblem-openshift-demo")
PROJECT_ID = os.environ.get("PROJECT_ID", "hack-team-entscheidungsproblem")
